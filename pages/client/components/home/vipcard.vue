		...
		<view v-if="userinfo.isLogin" class=" box pd16_15">
			 <navigator url="/pages/client/vipcard/index">	
				 <view class="home-vip-tag-box">
					 <image class="bg" v-if="userinfo.group_id <3" :src="statics.vipbg"></image>
					 <image  class="bg" v-else :src="statics.vipBgHas"></image>
					 <view v-if="userinfo.group_id <3" class="main plr15 flex alcenter space">
					 ...
					 <view v-else class="main plr15 flex alcenter space">
						 ...
						 <view class="flex alcenter">
							 <view  class="ft12 cl-default mr15 ftw400">您好！尊敬的VIP<br>到期:{{userinfo.dtime}}</view>
							 <image class="right-icon" :src="statics.rightIcon"></image>
						 </view>
					 </view>
				 </view>
			 ...
			 <view class="mt24 flex space">
				 <view class="col3 text-center">
					 ...
					 <view class="cl-notice ft12">我的积分</view>
					 <view class="mt8 ft20 ftw600 cl-default">{{userinfo.user_points}}</view>
					 </navigator>
				 </view>
				 ...
				 <view class="col3 text-center">
					 <navigator url="/pages/client/member/txjl">
						 <view class="cl-notice ft12">冻结积分</view>
						 <view class="mt8 ft20 ftw600 cl-default">{{userinfo.user_points_froze}}</view>
					 </navigator>
				 </view>
			 </view>
	...
	export default{
		...
		methods:{
			...
			showQrcodeAct(){
				//this.$emit('qrcode');
				uni.navigateTo({
					url:'/pages/client/member/qrshareuser'
				})
			},
			wdfxm(){
				uni.navigateTo({
