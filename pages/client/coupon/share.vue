<template>
	<view class="pd16_15">
		...
		<view class="mt24">
			<button class="btn-big" :style="{color:tempColor,background:'#fff'}">查看更多优惠券 <text class="iconfont iconicon_arrow_small ft14 ml10"></text></button>
		</view>
	</view>
</template>
