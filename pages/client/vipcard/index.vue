			...
			<view class="main pt20">
				<view class="flex alcenter space">
					<view class="col3 text-center">
						<view class="ft12 cl-w8"></view>
						<view class="mt8 vipcard-num"></view>
					</view>
					...
					<view class="col3 text-center">
						<view class="ft12 cl-w8"></view>
						<view v-if="userinfo.dqts>=0" class="mt8 vipcard-num"></view>
						<view v-if="userinfo.dqts<0" class="mt8 vipcard-num"></view>
					</view>
				</view>
							...
							<view class="card">
								...
								<view class="main">
									...
									<view class="mt20 flex center">
										<view @click="vipcm" v-if="vipLevel < 3" class="vipcard-info"><text class="ft14 ftw600 ml4 cl-main">立即升级</text></view>
										<view @click="vipcm" v-if="vipLevel == 3" class="vipcard-info ft12">到期时间：{{userinfo.dtime}}</view>
									</view>
								</view>
							</view>
						</view>
