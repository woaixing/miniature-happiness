		...
		<view class="box over-hide">
			<view class="recharge-header">
				...
				<view class="main pd24_20">
					<view class="ft16 cl-w9">当前积分</view>
					<view class="mt16 ftw600 ft32 cl-w">{{userinfo.user_points}}</view>
				</view>
			</view>
			<navigator url="/pages/client/vipcard/moneylog">
				<view class="pd16_15 flex alcenter space">
					<text class="ft14 ftw600 cl-main">积分明细 </text>
	...
	export default{
		...
		methods:{
			...
			async ongrzlTap(){
				...
				let data = {};
				let [err,res] =await this.$httpas.get('api.php/User/index',data,{token:true});
