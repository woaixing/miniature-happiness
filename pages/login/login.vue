  ...
  <view class="content" v-if="idfd==1">
    ...
    <view class="list">
      <view class="list-call">
        ...
        <input class="sl-input" v-model="mobile" type="text" maxlength="11" placeholder="输入用户名/手机号" />
      </view>
      <view class="list-call">
  ...
  export default {
    ...
    methods: {
      ...
      async bindLogin() {
        ...
        let data = {'user_name':this.mobile,'user_pwd':this.password};
        let [err,res] =await this.$httpas.post('api.php/User/login',data);
